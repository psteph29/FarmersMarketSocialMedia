...
class MarketListTableViewController: UITableViewController {
    ...
    func loadFarms() {
        Task {
            do {
                let fetchedFarms = try await APIFarmController.fetchFarms(state: searchBar.text)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "market", for: indexPath) as! MarketTableViewCell
        
        let farm = farms[indexPath.row]
        
        cell.update(with: farm)
...
extension MarketListTableViewController: UISearchBarDelegate {
